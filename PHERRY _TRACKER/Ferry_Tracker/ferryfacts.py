...
#Read facts
    with open('/home/root/ferryfacts.txt', 'r') as f:
...
with open('/home/root/ferryfacts.txt', 'r', encoding="utf-8") as g:
    lines = g.read().splitlines()
with open("/home/root/alreadyasked.txt", encoding="utf-8") as f:
...
if len(lines) == len(line):
    with open('/home/root/alreadyasked.txt', 'w', encoding="utf-8") as k:
        k.write("")
...
with open('/home/root/alreadyasked.txt', 'a', encoding="utf-8") as h:
    h.write(str(randF) + "\n")'''
